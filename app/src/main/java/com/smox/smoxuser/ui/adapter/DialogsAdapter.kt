...
import com.smox.smoxuser.utils.getColorCircleDrawable
import com.smox.smoxuser.utils.getGreyCircleDrawable
import com.smox.smoxuser.utils.qb.getDialogName
...
class DialogsAdapter(var context: Context, var dialogs: List<QBChatDialog>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (dialog.type == QBDialogType.GROUP) {
            ...
            holder.dialogImageView.setImageResource(R.drawable.user)
        }
