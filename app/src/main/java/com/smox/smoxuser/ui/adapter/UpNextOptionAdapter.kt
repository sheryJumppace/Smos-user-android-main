...
import com.smox.smoxuser.databinding.ListItemUpnextOptionBinding
import com.smox.smoxuser.model.UpNextOption


class UpNextOptionAdapter : ListAdapter<UpNextOption, UpNextOptionAdapter.ViewHolder>(UpNextOptionDiffCallback()) {
